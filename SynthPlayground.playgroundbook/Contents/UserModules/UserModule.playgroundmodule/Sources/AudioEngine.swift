...
public class AudioEngine{
    ...
    public func getAudioUnit() -> SynthAudioUnit{
        assert(initialized, "You must call start() before trying to get the AudioUnit. Wait for everything to finish initializing")
    ...
    public func start() throws -> Void{
        ...
        let description = AudioComponentDescription(componentType: kAudioUnitType_Generator, componentSubType: kAudioUnitSubType_MIDISynth, componentManufacturer: kAudioUnitManufacturer_Apple, componentFlags: 0, componentFlagsMask: 0);
        ...
        do{
            ...
            throw NSError(domain: "", code: -3, userInfo: [NSLocalizedFailureReasonErrorKey : "Failed to initialize audio engine."]);
        }
