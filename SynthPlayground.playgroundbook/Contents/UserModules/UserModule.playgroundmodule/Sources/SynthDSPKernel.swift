...
class SynthDSPKernel : DSPKernel {
    ...
    private var inBufferList : UnsafeMutableAudioBufferListPointer? = nil;
    private var outBufferList: UnsafeMutableAudioBufferListPointer? = nil;
    ...
    public override func process(_ frameCount: AUAudioFrameCount, _ bufferOffset: AUAudioFrameCount) -> Void{
