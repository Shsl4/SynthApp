...
class DSPKernel {
    ...
    public func process(_ frameCount: AUAudioFrameCount, _ bufferOffset: AUAudioFrameCount) {

    }

    public func handleMIDIEvent(_ midiEvent: AUMIDIEvent) { }
    public func handleParameterEvent(_ parameterEvent: AUParameterEvent) { }

    public func processWithEvents(_ timestamp: UnsafePointer<AudioTimeStamp>, _ frameCount: AUAudioFrameCount, _ events: UnsafePointer<AURenderEvent>?, _ midiOut: AUMIDIOutputEventBlock?) {
