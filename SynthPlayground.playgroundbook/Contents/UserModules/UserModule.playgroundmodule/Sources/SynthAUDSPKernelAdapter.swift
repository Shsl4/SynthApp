...
class SynthAUDSPKernelAdapter{
    ...
    var audioUnit : SynthAudioUnit? = nil;
    ...
    public func allocateRenderResources() -> Void{
    ...
    public func internalRenderBlock() -> AUInternalRenderBlock{
        ...
        return { [state = kernel, input = inputBus] (actionFlags, timestamp, frameCount, outputBusNumber, outputData, realtimeEventListHead, pullInputBlock) in
