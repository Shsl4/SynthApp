...
public class SynthAudioUnit: AUAudioUnit {
    ...
    private var _krnl: SynthAUDSPKernelAdapter?
     ...
     */
    public func updateSignal(_ signal : @escaping (Float) -> Float, forOsc: Int, name: String) {
     ...
     */
    public func setParameterValue(_ parameter: Parameters, value: AUValue) {
     ...
     */
    private func addOscillator(osc: Oscillator) {
     ...
     */
    public func onNoteOff(noteNumber: Int) {
     ...
     */
    internal func setupParametersCallbacks() {
